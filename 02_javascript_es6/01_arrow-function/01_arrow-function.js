/*
    ...
    - 화살표 함수 사용 시
        ...
        상위 스코프(고차 함수인 forEach)에서 상속 받아 화살표 함수가 정의 된 
...
// new arrowFunc(); // 화살표 함수는 생성자로 사용 할 수 없어 Error 발생
new normalFunc();
...
const test2 = function() {
    console.log('nomal function일 경우:', arguments);
}
