...
/* ES6에서 스프레드 연산자를 통해 concat의 개념을 할 수도 있다. */
...
console.log(`front.slice() : ${front.slice(1, 3)}`);        // 1 ~ 2(endindex - 1) 인덱스까지 복사
console.log(`front: ${front}`);

console.log(`front.splice() : ${front.splice(2, 2, 'React')}`); // 2번(인수 1) 인덱스부터 2길이만큼(인수 2) 치환(인수 3)
console.log(`front: ${front}`);
